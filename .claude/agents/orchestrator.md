...
Read all skill sheets in `.claude/agents/manifests/`:
...
#### For Merged Agents:
1. Retrieve source agents' prompts from `.claude/agents/`
...
5. Add new agent file to `.claude/agents/`
6. Save skill sheet to `.claude/agents/manifests/`
...
4. Add agent file to `.claude/agents/`
5. Save skill sheet to `.claude/agents/manifests/`
...
All agents must have a skill sheet in `.claude/agents/manifests/{agent-name}.yaml`:
